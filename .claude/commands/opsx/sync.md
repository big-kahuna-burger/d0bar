...
Invoke the `openspec-sync-specs` skill and follow it. It is the single source of truth for this
workflow; everything below is only about how `/opsx:sync` reads its argument.
