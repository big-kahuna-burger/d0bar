...
Invoke the `openspec-apply-change` skill and follow it. It is the single source of truth for this
workflow; everything below is only about how `/opsx:apply` reads its argument.
