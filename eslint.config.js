...
export default tseslint.config(
  {
    ...
    ignores: [
      "dist",
      ".claude",
      "design_handoff_d0bar",
      "src/collector/tokens.gen.ts",
      /* Generated by `scripts/build-otel-fixture.mjs` — a bundle of someone else's SDK, for
         the fixture only. Never shipped, never edited, and linting it would report their
         style choices as ours. */
      "bench/fixtures/host/otel-sdk.js",
    ],
  },
